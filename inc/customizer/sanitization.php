 ...
 */
function pinto_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function pinto_sanitize_image( $image, $setting ) {
	/*
 ...
 */
function pinto_sanitize_nohtml( $nohtml ) {
 ...
 */
function pinto_sanitize_html( $input ) {
 ...
 */
function pinto_sanitize_number_absint( $number, $setting ) {
 ...
 * @return int Sanitized number; otherwise, the setting default.
 */
function pinto_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 */
function pinto_sanitize_select( $input, $setting ) {
